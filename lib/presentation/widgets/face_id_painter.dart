...
class FaceIDPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final facePaint = Paint()
      ...
      ..color = const Color(0xFFEB4A5A).withOpacity(faceOpacity)
    ...
    final eyeBlinkPaint = Paint()
      ...
      ..color = canBlink
          ? Colors.transparent
          : const Color(0xFFEB4A5A).withOpacity(faceOpacity)
      ..strokeCap = StrokeCap.round;
    ...
    final check1 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canShowCheck1 ? const Color(0xFFEB4A5A) : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
    ...
    final check2 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canShowCheck2 ? const Color(0xFFEB4A5A) : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
      Offset(oneHalf, s * .7),
